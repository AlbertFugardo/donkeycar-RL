...
class DonkeyUnitySimHandler(IMesgHandler):
    def __init__(self, conf: Dict[str, Any]):
        ...
        self.vel_z = 0.0
        self.lidar = []
        self.n_steps_low_speed = 0 # count how many steps we are below a certain speed
        self.min_speed = 0.2
        self.n_steps = 0
    ...
    def set_reward_fn(self, reward_fn: Callable[[], float]):
        ...
        print("custom reward function set.")
    ...
    def determine_episode_over(self):
        ...
        if abs(self.speed) < self.min_speed and self.n_steps > 100: # second condition as in the beginning the speed is low
            self.n_steps_low_speed += 1
            if self.n_steps_low_speed > 40:
                self.over = True
